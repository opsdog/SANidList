...
int main ( int argc, char *argv[] )
{
  ...
  Index4=StringIndex(Digit4,argv[1][0]);
  Index3=StringIndex(Digit3,argv[1][1]);
  Index2=StringIndex(Digit2,argv[1][3]);
  Index1=StringIndex(Digit1,argv[1][4]);

#ifdef DEBUG
  printf("parsed starting serial number:  %s = ", argv[1]);
  printf("%c%c:%c%c\n", 
	 Digit4[Index4], Digit3[Index3], Digit2[Index2], Digit1[Index1]);
